...
```toml
[dependencies]
huginn-net = "1.5.1"  # Complete analysis suite
```

**For specific protocols:**
```toml
[dependencies]
huginn-net-tcp = "1.5.1"   # TCP/OS fingerprinting only
huginn-net-http = "1.5.1"  # HTTP analysis only  
huginn-net-tls = "1.5.1"   # TLS/JA4 analysis only
```
