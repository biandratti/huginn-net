...
```toml
[dependencies]
huginn-net = "1.6.1"  # Complete analysis suite
```

**For specific protocols:**
```toml
[dependencies]
huginn-net-tcp = "1.6.1"   # TCP/OS fingerprinting only
huginn-net-http = "1.6.1"  # HTTP analysis only  
huginn-net-tls = "1.6.1"   # TLS/JA4 analysis only
```
...
- **Parallel support**: TCP scales to 2.11M pps (4 workers), HTTP to 1.54M pps (2 workers), TLS to 623.4K pps (4 workers)
