...
```toml
[dependencies]
huginn-net = "1.5.2"  # Complete analysis suite
```

**For specific protocols:**
```toml
[dependencies]
huginn-net-tcp = "1.5.2"   # TCP/OS fingerprinting only
huginn-net-http = "1.5.2"  # HTTP analysis only  
huginn-net-tls = "1.5.2"   # TLS/JA4 analysis only
```
