...
```toml
[dependencies]
huginn-net = "1.7.0"  # Complete analysis suite
```

**For specific protocols:**
```toml
[dependencies]
huginn-net-tcp = "1.7.0"   # TCP/OS fingerprinting only
huginn-net-http = "1.7.0"  # HTTP analysis only  
huginn-net-tls = "1.7.0"   # TLS/JA4 analysis only
```
