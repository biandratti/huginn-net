...
use huginn_net_db::tcp::TcpOption::{Mss, Nop, Sok, TS, Ws};
...
lazy_static! {
    static ref LABELS: Vec<(&'static str, Label)> = vec![
        ...
        (
            "s:!:curl:",
            Label { ty: Type::Specified, class: None, name: "curl".to_owned(), flavor: None },
        )
    ];
    ...
    static ref HTTP_HEADERS: Vec<(&'static str, HttpHeader)> = vec![
        ...
        (
            "User-Agent",
            HttpHeader { optional: false, name: "User-Agent".to_owned(), value: None }
        ),
        (
            "Accept=[,*/*;q=]",
            HttpHeader {
                ...
                value: Some(",*/*;q=".to_owned())
            }
        ),
        (
            "?Accept-Language",
            HttpHeader { optional: true, name: "Accept-Language".to_owned(), value: None }
        ),
    ];
}
