...
pub enum Quirk {
    ...
    ///
    /// Note: This quirk is not currently generated by the packet processing logic
    /// to maintain compatibility with real-world TCP implementations that may have
    /// slightly non-conformant but functional option lengths. However, it is kept
    /// for compatibility with p0f signature databases that may reference it.
    OptBad,
}
