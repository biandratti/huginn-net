...
use crate::process::parallel::WorkerPool;
use crate::process::{process_ipv4_packet, process_ipv6_packet, FlowKey};
...
impl HuginnNetTls {
    ...
    pub fn stats(&self) -> Option<crate::process::parallel::PoolStats> {
