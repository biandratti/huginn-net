...
//! | `stable-v1` | No      | Adds [`Signature::generate_ja4_stable_v1`] / [`ObservableTlsClient::ja4_stable_v1`]: JA4 minus [`S1_SESSION_EXTENSIONS`], so resumption does not split the key. |
