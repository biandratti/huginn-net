<div align="center">
  ...
  [![MSRV](https://img.shields.io/crates/msrv/huginn-net-tls.svg)](https://crates.io/crates/huginn-net-tls)
...
```toml
[dependencies]
huginn-net-tls = { version = "2.2.0", features = ["full"] }
```
...
```toml
[dependencies]
huginn-net-tls = { version = "2.2.0", features = ["stable-v1"] }
```
