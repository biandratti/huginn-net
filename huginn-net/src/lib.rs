...
//! | `tls-stable-v1` | No | Adds `JA4_s1` / `JA4_rs1` via [`huginn_net_tls`]: JA4 minus the session / resumption extension types. The analyzer uses the canonical list; `Signature::generate_ja4_stable_v1_with_extra` widens it for a single call. |
