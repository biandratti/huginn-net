<div align="center">
  ...
  [![MSRV](https://img.shields.io/crates/msrv/huginn-net-http.svg)](https://crates.io/crates/huginn-net-http)
...
huginn-net-http = { version = "2.2.0", features = ["full"] }
...
# embedded).
huginn-net-db = { version = "2.2.0", features = ["http"] }
```
...
huginn-net-http = { version = "2.2.0", features = ["p0f-request"] }

# Akamai HTTP/2 fingerprinting only, no p0f path compiled in at all.
huginn-net-http = { version = "2.2.0", features = ["akamai"] }

# Both p0f sides, no akamai.
huginn-net-http = { version = "2.2.0", features = ["p0f-request", "p0f-response"] }
```
