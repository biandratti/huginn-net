...
huginn-net-http = { version = "2.1.0", features = ["full"] }
...
# embedded).
huginn-net-db = { version = "2.1.0", features = ["http"] }
```
...
huginn-net-http = { version = "2.1.0", features = ["p0f-request"] }
...
huginn-net-http = { version = "2.1.0", features = ["p0f-request", "p0f-response"] }
```
