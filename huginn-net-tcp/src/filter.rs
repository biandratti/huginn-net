...
///
/// ```rust
/// use huginn_net_tcp::SubnetFilter;
///
...
///
/// ```rust
/// use huginn_net_tcp::{FilterConfig, FilterMode, PortFilter, SubnetFilter};
///
...
impl FilterConfig {
    ...
    ///
    /// ```
    /// use huginn_net_tcp::{FilterConfig, FilterMode};
    ///
    ...
    ///
    /// ```rust
    /// use huginn_net_tcp::{FilterConfig, PortFilter};
    ///
    /// let filter = FilterConfig::new()
    ///     .with_port_filter(PortFilter::new().destination(443));
    /// ```
    ...
    ///
    /// ```rust
    /// use huginn_net_tcp::{FilterConfig, IpFilter};
    ///
    /// let filter = FilterConfig::new()
    ///     .with_ip_filter(
    ///         IpFilter::new()
    ...
    ///
    /// ```rust
    /// use huginn_net_tcp::{FilterConfig, SubnetFilter};
    ///
    /// let filter = FilterConfig::new()
    ///     .with_subnet_filter(
    ///         SubnetFilter::new()
